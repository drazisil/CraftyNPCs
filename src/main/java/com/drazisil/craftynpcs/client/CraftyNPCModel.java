...
@OnlyIn(Dist.CLIENT)
public class CraftyNPCModel<T extends Entity> extends EntityModel<T> implements IHasHead, IHeadToggle {
    ...
    public CraftyNPCModel() {
        this(0.1f, 64, 64);
    }

    public CraftyNPCModel(float scale) {
        this(scale, 64, 64);
    }

    public CraftyNPCModel(float p_i51059_1_, int p_i51059_2_, int p_i51059_3_) {
        float f = 0.5F;
